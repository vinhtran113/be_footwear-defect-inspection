...
class CameraManager:
    ...
    def _capture_loop(self):
        """Vòng lặp capture frame từ camera - chỉ cập nhật frame mới nhất mà không phát hiện"""
    ...
    def capture_frame(self):
        """Chụp một frame hiện tại từ camera"""
    ...
    def capture_and_process_frame(self):
        """Chụp một frame mới và xử lý ngay lập tức"""
        frame = self.capture_frame()
        if frame is None:
            return None
            
        # Lưu frame mới để xử lý
        self.frame = frame
